...
const SEED_PROJECTS: SeedProjectSpec[] = [
  {
    ...
    budgetHours: 600,
    tasks: [
      { skill: "P", hours: 120, row: 0 },
      { skill: "A", hours: 80, row: 0 },
      { skill: "B", hours: 64, row: 1 },
      { skill: "S", hours: 96, row: 2 },
      { skill: "E", hours: 72, row: 3 },
      { skill: "C", hours: 88, row: 4 },
    ],
  },
  {
    code: "Z2",
    ...
    budgetHours: 200,
    tasks: [
      { skill: "A", hours: 100, row: 0 },
      { skill: "S", hours: 90, row: 0 },
      { skill: "E", hours: 56, row: 1, status: "ON_HOLD" },
      { skill: "C", hours: 64, row: 1 },
    ],
  },
  {
    code: "Z3",
    ...
    budgetHours: 300,
    tasks: [
      { skill: "A", hours: 72, row: 0 },
      { skill: "B", hours: 48, row: 0 },
      { skill: "S", hours: 80, row: 1 },
      { skill: "E", hours: 40, row: 2 },
      { skill: "C", hours: 44, row: 2, taskDeadlineOffsetWorkdays: 5 },
    ],
  },
];
