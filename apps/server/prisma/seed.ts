...
const SEED_PROJECTS: SeedProjectSpec[] = [
  {
    ...
    tasks: [
      ...
      { skill: "A", hours: 80, row: 0, name: "BD-A" },
      { skill: "B", hours: 64, row: 1, name: "DD-B" },
      { skill: "S", hours: 96, row: 2, name: "CD-S" },
  ...
  },
  {
    ...
    budgetHours: 200,
    tasks: [
      { skill: "A", hours: 100, row: 0, name: "DD-A" },
      { skill: "S", hours: 90, row: 0, name: "CD-S" },
      { skill: "E", hours: 56, row: 1, status: "ON_HOLD", name: "BD-E" },
      { skill: "C", hours: 64, row: 1, name: "CD-C" },
    ],
  },
  {
    code: "Z3",
    ...
    budgetHours: 300,
    tasks: [
      { skill: "A", hours: 72, row: 0, name: "BD-A" },
      { skill: "B", hours: 48, row: 0, name: "CD-B" },
      { skill: "S", hours: 80, row: 1, name: "DD-S" },
      { skill: "E", hours: 40, row: 2, name: "CD-E" },
